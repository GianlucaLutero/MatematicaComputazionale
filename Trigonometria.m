...
DynamicModule[{},
If[answer == "",Text[""],If[answer == correct,Style["\[Checkmark]",FontColor->Green],Style["X",FontColor->Red,Bold],Text[""]],Text[""]]
...
{Magnify[Graphics[{
 ...
 {Opacity[0],EdgeForm[Directive[Black]], Triangle[{{0, 0}, {0,1}, {2, 0}}]},
  ...
  Text[Style["A", 10],
   {1, 0.6}, {-1, 0}],
 Text[Style["\[Beta]", 10,Darker[Green,0.3]], {1.6, 0.08}],
 Text[Style["\[Gamma]",10,Darker[Green,0.3]],{0.085,0.75}],
 Text[Style["\[Alpha]",10,Darker[Green,0.3]],{0.2,0.2}]
  }],2]
...
PopupMenu[Dynamic[G7],{"\[Alpha]","\[Gamma]"}],Dynamic[CheckAnswer[G7,"\[Gamma]"]],")" }]]},
